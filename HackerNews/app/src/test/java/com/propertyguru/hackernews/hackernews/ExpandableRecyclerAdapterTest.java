...
//        mDataObserver = fixAdapterForTesting(mExpandableRecyclerAdapter);
//    }
//
//    @Test
...
//        return mExpandableRecyclerAdapter.getParentList().get(flatPosition);
...
////        }
//    }
//    public  RecyclerView.AdapterDataObserver fixAdapterForTesting(RecyclerView.Adapter adapter) throws NoSuchFieldException, IllegalAccessException {
...
//    }
//
//    private  class TestExpandableRecyclerAdapter extends ExpandableRecyclerAdapter<Parent<Object>, Object, ParentViewHolder, ChildViewHolder> {
//
